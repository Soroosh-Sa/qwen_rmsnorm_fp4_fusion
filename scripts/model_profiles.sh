...
# Backward-compatible alias used by newer engine scripts.
export ORIG_NVFP4_PATH="${ORIG_NVFP4_PATH:-$ORIGINAL_NVFP4_PATH}"
...
export ORIGINAL_ENGINE_DIR="${ORIGINAL_ENGINE_DIR:-$ENGINE_ROOT/${MODEL_TAG}-NVFP4-engine-tp${TP_SIZE:-4}}"
export FOLDED_ENGINE_DIR="${FOLDED_ENGINE_DIR:-$ENGINE_ROOT/${MODEL_TAG}-FOLDED-NVFP4-engine-tp${TP_SIZE:-4}}"
...
Selected model profile
  ...
  ORIGINAL_NVFP4_PATH=$ORIGINAL_NVFP4_PATH
  ORIG_NVFP4_PATH=$ORIG_NVFP4_PATH
